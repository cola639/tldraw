...
export const DEFAULT_TRANSLATION = {
	...
	'context-menu.export-all-as': '导出为',
	...
	'file-system.confirm-clear.description':
		'创建新项目将清除您当前的项目，并且所有未保存的更改都将丢失。确定要继续吗？',
	...
	'file-system.confirm-open.description':
		'打开文件将替换您的当前项目，任何未保存的更改将丢失。确定要继续吗？',
	...
	'file-system.file-open-error.file-format-version-too-new':
		'您试图打开的文件来自 tldraw 新版本。请重新加载页面，然后重试。',
	...
	'share-menu.offline-note':
		'共享此项目将以新 URL 创建托管活动副本。您可以与不超过三十人共享此 URL，一起查看和编辑项目。',
	...
	'share-menu.upload-failed':
		'抱歉，我们目前无法上传您的项目，请重试。如果问题仍然存在，请告诉我们。',
	'sharing.confirm-leave.cancel': '取消',
	'sharing.confirm-leave.description':
		'您确定要退出这个共享项目吗？您可以通过访问它的 URL 以返回。',
